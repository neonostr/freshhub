...
></div>
          ...
          <div
            ...
            style={{
              ...
              paddingBottom: `calc(env(safe-area-inset-bottom) + 7rem)`, // Space for floating buttons + PWA banner
          ...
          <div className="absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t from-background via-background/80 to-transparent z-100 pointer-events-none"></div>
        </main>
