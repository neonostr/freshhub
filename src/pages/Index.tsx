    ...
    <HeaderVisibilityProvider>
      ...
      <div className="flex flex-col h-screen w-full max-w-5xl mx-auto relative overflow-hidden bg-background">
        ...
        {!hideHeader && (
          ...
          <header className="flex-shrink-0 pt-6 px-4 text-center bg-background relative z-20" id="app-header" style={{ paddingTop: `calc(1rem + env(safe-area-inset-top))` }}>
            <h1 className="text-3xl font-bold"><span className="underline decoration-[#49DE80]">FreshHub</span></h1>
            <p className="text-gray-500 mt-6">All your shelf life in one spot</p>
          </header>
        )}
        ...
        <main className="flex-1 relative overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-36 bg-gradient-to-t from-background via-background/80 to-transparent z-100 pointer-events-none"></div>
        </main>
