...
import { 
  ...
  ChevronDown, Filter, FlaskConical as Flask, Lemon as LemonIcon, Grape, Circle as Orange, 
  Bookmark as BreadIcon, Circle as SaltIcon, Circle as PepperIcon, 
  Martini, BowlFood as BowlIcon, Baby, Axe, BookOpen, Flame as FlameKindling, Bookmark, BookPlus, Cactus, Calculator, 
  ...
  Wheat as FlourIcon, Flower, FolderIcon as Folder, FolderArchive, FolderDown,
  ...
  Flower as GingerIcon, Flower as FlowerIcon, Cookie as GingerbreadIcon, 
  Circle as Glass, Glasses as GlassWaterIcon, Wine as GlassWineIcon, Globe, Globe as GlobeIcon, Wheat as GrainIcon, 
  Grape as GrapeClusterIcon, Citrus as GrapefruitIcon, Bean as GreenBeansIcon, Leaf as GreenOnionIcon,
  ...
  IceCream as IceCreamScoopIcon, Martini as IceCreamShakeIcon, Image, Inbox, IndentDecrease, IndianRupee, Pumpkin,
  ...
  Circle as CannedPumpkinIcon, Pumpkin as PumpkinIcon2, Puzzle, QrCode, Quote, Circle as RabbitIcon,
...
export const ALL_ICONS: Record<string, IconOption> = {
  ...
  dessert: { value: 'dessert', label: 'Dessert', icon: <DessertIcon className="h-5 w-5" />, shelfLife: 5 },
  ...
  shoppingBag: { value: 'shoppingBag', label: '
